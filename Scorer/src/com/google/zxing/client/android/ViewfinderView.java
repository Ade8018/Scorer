...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		int frame_bottom = (int) (frame.bottom * 0.7);
		paint.setColor(resultBitmap != null ? resultColor : maskColor);
		canvas.drawRect(0, 0, width, frame.top, paint);
		canvas.drawRect(0, frame.top, frame.left, frame_bottom + 1, paint);
		canvas.drawRect(frame.right + 1, frame.top, width, frame_bottom + 1, paint);
		canvas.drawRect(0, frame_bottom + 1, width, height, paint);
...
//			canvas.drawBitmap(resultBitmap, null, frame, paint);
			...
			int middle = (int)((frame_bottom-frame.top)/2) + frame.top;
